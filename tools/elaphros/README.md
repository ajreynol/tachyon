...
**Twelve of the sixteen tables name branches — twenty in all — and not
one carries a number.** A direction may own several, because competing designs
for one mechanism compete in the same table. Nineteen of the twenty are within eleven commits of cvc5 `main@1c0b2066`,
read on 2026-09-23, and the last column names a corpus this
