...
The counters named in the [directions](../docs/directions.md) exist, but the
...
instrument that [E13](../docs/directions.md#e13-proof-work-accounting)
...
([E14](../docs/directions.md#e14-proof-node-representation-and-allocation)),
full materialization before output
([E15](../docs/directions.md#e15-streaming-proof-emission)), repeated whole-DAG
passes ([E16](../docs/directions.md#e16-traversal-fusion)), and the absence of
a phase partition or a discarded-work counter
([E13](../docs/directions.md#e13-proof-work-accounting)). Their priority
