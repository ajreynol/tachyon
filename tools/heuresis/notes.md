...
| `--ee-mode=central` | 63 net additional solves and 9.6% lower PAR2 in the fresh whole-set control | broad correctness surface; repeat on current main before treating this as a default ([ledger](ledger/2026-09-16-datatype-and-equality-controls.md)) |
| `--ieval=off` | 16 net additional solves and 3.1% lower PAR2; composes positively with central equality | points specifically at partial-evaluator cost or pruning, not at removing final entailment checks ([ledger](ledger/2026-09-16-entailment-filtering.md)) |
