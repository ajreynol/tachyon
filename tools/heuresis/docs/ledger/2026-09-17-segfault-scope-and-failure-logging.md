...
result token is deliberately unchanged: [`gap`](../../reports/gap) has a fixed column list
...
[`progress.md`](../progress.md) divides by that number.
...
[`progress.md`](../progress.md) requires in order to mean anything.
