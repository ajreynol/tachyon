...
[`data/gapset-u-sc-cbqi-conflict-vs-z3-full-091626.txt`](../../reports/data/gapset-u-sc-cbqi-conflict-vs-z3-full-091626.txt).

## 4. What came back

Solve-result files in [`data/`](../../reports/data), read by [`gap`](../../reports/gap):
...
[data-retention policy](../../reports/data/README.md)). It contains 6124 benchmark blocks.
