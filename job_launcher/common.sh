# common.sh -- sourced by job_launcher/deploy and job_launcher/fetch.
...
#   host scripts in host/ are all part of this repository; see docs/job-launcher.md.
